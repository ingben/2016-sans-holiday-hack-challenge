...
.method protected static a(Landroid/content/Context;Landroid/support/v7/widget/m;I)Landroid/support/v7/widget/az;
    .locals 3
...
.method a()V
    ...
    iget-object v0, p0, Landroid/support/v7/widget/z;->d:Landroid/support/v7/widget/az;

    if-nez v0, :cond_0

    iget-object v0, p0, Landroid/support/v7/widget/z;->e:Landroid/support/v7/widget/az;

    if-nez v0, :cond_0

    iget-object v0, p0, Landroid/support/v7/widget/z;->f:Landroid/support/v7/widget/az;

    if-nez v0, :cond_0

    iget-object v0, p0, Landroid/support/v7/widget/z;->g:Landroid/support/v7/widget/az;
    ...
    iget-object v2, p0, Landroid/support/v7/widget/z;->d:Landroid/support/v7/widget/az;

    invoke-virtual {p0, v1, v2}, Landroid/support/v7/widget/z;->a(Landroid/graphics/drawable/Drawable;Landroid/support/v7/widget/az;)V

    const/4 v1, 0x1

    aget-object v1, v0, v1

    iget-object v2, p0, Landroid/support/v7/widget/z;->e:Landroid/support/v7/widget/az;
    ...
    iget-object v2, p0, Landroid/support/v7/widget/z;->f:Landroid/support/v7/widget/az;
    ...
    iget-object v1, p0, Landroid/support/v7/widget/z;->g:Landroid/support/v7/widget/az;

    invoke-virtual {p0, v0, v1}, Landroid/support/v7/widget/z;->a(Landroid/graphics/drawable/Drawable;Landroid/support/v7/widget/az;)V
...
.method final a(Landroid/graphics/drawable/Drawable;Landroid/support/v7/widget/az;)V
    ...
    invoke-static {p1, p2, v0}, Landroid/support/v7/widget/m;->a(Landroid/graphics/drawable/Drawable;Landroid/support/v7/widget/az;[I)V
...
.method a(Landroid/util/AttributeSet;I)V
    ...
    invoke-static {v4, v0, v6}, Landroid/support/v7/widget/z;->a(Landroid/content/Context;Landroid/support/v7/widget/m;I)Landroid/support/v7/widget/az;

    move-result-object v6

    iput-object v6, p0, Landroid/support/v7/widget/z;->d:Landroid/support/v7/widget/az;
    ...
    iput-object v6, p0, Landroid/support/v7/widget/z;->e:Landroid/support/v7/widget/az;
    ...
    iput-object v6, p0, Landroid/support/v7/widget/z;->f:Landroid/support/v7/widget/az;
    ...
    iput-object v0, p0, Landroid/support/v7/widget/z;->g:Landroid/support/v7/widget/az;
