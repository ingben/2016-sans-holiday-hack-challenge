...
.field private d:Landroid/support/v4/j/az;

.field private e:Z

.field private final f:Landroid/support/v4/j/ba;
...
.method public constructor <init>()V
    ...
    iput-object v0, p0, Landroid/support/v7/view/h;->f:Landroid/support/v4/j/ba;
...
.method static synthetic a(Landroid/support/v7/view/h;)Landroid/support/v4/j/az;
    .locals 1

    iget-object v0, p0, Landroid/support/v7/view/h;->d:Landroid/support/v4/j/az;
...
.method public a(Landroid/support/v4/j/av;)Landroid/support/v7/view/h;
    .locals 1
...
.method public a(Landroid/support/v4/j/av;Landroid/support/v4/j/av;)Landroid/support/v7/view/h;
    .locals 2
    ...
    invoke-virtual {p1}, Landroid/support/v4/j/av;->a()J

    move-result-wide v0

    invoke-virtual {p2, v0, v1}, Landroid/support/v4/j/av;->b(J)Landroid/support/v4/j/av;
...
.method public a(Landroid/support/v4/j/az;)Landroid/support/v7/view/h;
    .locals 1
    ...
    iput-object p1, p0, Landroid/support/v7/view/h;->d:Landroid/support/v4/j/az;
...
.method public a()V
    ...
    invoke-virtual {v0, v2}, Landroid/support/v4/j/av;->a(Landroid/view/animation/Interpolator;)Landroid/support/v4/j/av;

    :cond_2
    iget-object v2, p0, Landroid/support/v7/view/h;->d:Landroid/support/v4/j/az;

    if-eqz v2, :cond_3

    iget-object v2, p0, Landroid/support/v7/view/h;->f:Landroid/support/v4/j/ba;

    invoke-virtual {v0, v2}, Landroid/support/v4/j/av;->a(Landroid/support/v4/j/az;)Landroid/support/v4/j/av;
